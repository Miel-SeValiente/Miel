...
import { GoogleGenAI } from "https://esm.sh/@google/genai@0.2.1";
...
// --- components/Icons.js ---
const TShirtIcon = (props) => React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", ...props },
...
const WhatsAppIcon = (props) => React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 16 16", fill: "currentColor", ...props },
...
const SparkleIcon = (props) => React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", ...props },
    ...
    React.createElement('main', { className: "flex-grow overflow-y-auto p-4 flex flex-col items-center gap-4 pb-40" },
      React.createElement('div', { className: "w-full max-w-2xl mx-auto" },
        isLoadingVerse && !currentVerse ? 
          React.createElement('div', { className: "flex justify-center items-center h-64" }, React.createElement(LoadingSpinner, null)) :
        error ? 
          React.createElement('div', { className: "text-center text-red-600 bg-red-100 p-4 rounded-lg" }, error) :
        currentVerse ? 
          React.createElement(React.Fragment, null,
            ...
            React.createElement('div', { className: "flex flex-wrap justify-end items-center gap-3 mt-4 w-full" },
              React.createElement('button', {
                ...
                isGenerating ? 
                  React.createElement(React.Fragment, null, React.createElement(LoadingSpinner, null), React.createElement('span', null, "Generando...")) :
                  React.createElement(React.Fragment, null, 
                    React.createElement(SparkleIcon, { className: "h-5 w-5 transition-transform duration-300 group-hover:rotate-12" }),
                    React.createElement('span', null, 
                      aiReflection || generationError ? (showReflection ? 'Ocultar Reflexión' : 'Ver Reflexión') : 'Ver Reflexión'
                    )
                  )
              )
            ),
